...
const Res = () => {
  ...
  border: "none",
  outline: "none",
  cursor: "pointer" }}>Upload Image</button>
            </div>
          </div>
        </div>
       { (isuploaded === true)?
        <Form imageRef= {imageRef}/>: null}
      </>
    </div>
  )
}
