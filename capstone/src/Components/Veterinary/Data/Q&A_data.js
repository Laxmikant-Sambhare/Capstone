export const Questions = [
  ...
  //   {
  //     id: 3,
  //     question: "Can I Give My Dog Pepto Bismol For Upset Stomach?",
  //     Description:
  //       "When your tummy is upset, you may turn to Pepto-Bismol for some relief. You may be wondering whether this bright pink medication can be similarly effective for your dog. Can I Give My Dog Pepto Bismol For Upset Stomach. You can give your dog Pepto-Bismol, but it’s important to make a deliberate decision about giving this medication to your dog since there can be side effects and downsides to using it. That said, here’s what you need to know about giving your dog Pepto-Bismol, both when it may be effective and when you should think twice about using it.",
  //     image: require("../images/med.jpg"),
  //   },
];
