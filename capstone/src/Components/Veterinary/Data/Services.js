export const Services = [
  {
    ...
    Description:
      "Our Veterinary Clinic Mobile Offers 24 Hour Emergency Vet Care and Emergency ambulance service, As Well As Routine Veterinary Services For Your Pets. Our Exclusive Emergency Vet Clinic Near You is Known To Be The Best dog vet, Large dog vet, And Urgent Vet Clinic in Mobile To Treat Your Pet With Extra Kindness. Our Veterinary Clinic Mobile's emergency specialists and employees are focused toward Emergency Medicine To Cure Your Pet in the most dangerous circumstances. Our emergency team is led by the best employees in Mobile. Our certified veterinary specialists are highly experienced and can offer immediate treatment in serious cases. We have the largest group of emergency Veterinary Care Doctors in Mobile. Following your emergency, we connect you with a veterinarian to ensure your pet continues to recover properly.",
    image: require("../images/ambulance.jpg"),
  },
  {
    id: 2,
    service: "Consultation",
    Description: "Our team provide 24*7 hours consultation for dogs.",
  ...
  },
  {
    ...
    Description:
      "Our team provides round the clock veterinary services for dogs.",
